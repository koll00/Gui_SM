...
The ``SMlib.configs.userconfig`` module provides user configuration file (.ini file)
...
from SMlib.configs.baseconfig import DEV, TEST
from SMlib.utils import encoding
from SMlib.py3compat import configparser as cp
from SMlib.py3compat import is_text_string, PY2
