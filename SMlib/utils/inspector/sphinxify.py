...
# Local imports
from SMlib.configs.baseconfig import (_, get_module_data_path,
...
CONFDIR_PATH = get_module_source_path('SMlib.utils.inspector')
...
MATHJAX_PATH = get_module_data_path('SMlib',
                                    relpath=osp.join('utils', 'inspector',
                                                     JS_PATH, 'mathjax'),
                                    attr_name='MATHJAXPATH')

JQUERY_PATH = get_module_data_path('SMlib',
                                   relpath=osp.join('utils', 'inspector',
                                                    JS_PATH),
...
def generate_configuration(directory):
    ...
    conf = osp.join(get_module_source_path('SMlib.utils.inspector'),
                    'conf.py')
