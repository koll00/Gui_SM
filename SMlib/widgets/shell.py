...
from PyQt4.QtGui import (QMenu, QApplication, QToolTip, QKeySequence,
                                QMessageBox, QTextCursor, QTextCharFormat,
                                QShortcut)
from PyQt4.QtCore import (Qt, QCoreApplication, QTimer, SIGNAL,
                                 pyqtProperty)

# Local import
from SMlib.configs.baseconfig import get_conf_path, _, STDERR, DEBUG
from SMlib.configs.guiconfig import CONF, get_font
from SMlib.utils import encoding
from SMlib.utils.qthelpers import (keybinding, create_action, add_actions,
                                       restore_keyevent, get_icon,getsavefilename)
from SMlib.widgets.sourcecode.base import ConsoleBaseWidget
from SMlib.widgets.mixins import (InspectObjectMixin, TracebackLinksMixin,
                                      SaveHistoryMixin)
