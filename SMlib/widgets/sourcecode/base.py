...
from PyQt4.QtGui import (QTextCursor, QColor, QFont, QApplication,
                                ...
                                QTextFormat)
from PyQt4.QtCore import QPoint, SIGNAL, Qt, QEventLoop, QEvent, QVariant


# Local imports
from SMlib.widgets.sourcecode.terminal import ANSIEscapeCodeHandler
from SMlib.widgets.mixins import BaseEditMixin
from SMlib.py3compat import to_text_string, str_lower
