...
from PyQt4.QtGui import (QVBoxLayout, QLabel, QHBoxLayout, QInputDialog,
                                QFileSystemModel, QMenu, QWidget, QToolButton,
                                QLineEdit, QMessageBox, QToolBar, QTreeView,
                                QDrag, QSortFilterProxyModel)
from PyQt4.QtCore import (Qt, SIGNAL, QMimeData, QSize, QDir, QUrl,
                                 pyqtSignal, QTimer)
#from PyQt4.compat import getsavefilename, getexistingdirectory
...
from SMlib.utils.qthelpers import (get_icon, create_action, add_actions,
                                       file_uri,getsavefilename, getexistingdirectory)
from SMlib.utils import misc, encoding, programs, vcs
