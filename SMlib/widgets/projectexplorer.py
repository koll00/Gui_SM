...
# Local imports
from SMlib.utils import misc
from SMlib.utils.qthelpers import get_icon, get_std_icon, create_action,getexistingdirectory
from SMlib.configs.baseconfig import _, STDERR, get_image_path
from SMlib.widgets.explorer import FilteredDirView, listdir, fixpath
from SMlib.widgets.formlayout import fedit
...
class ExplorerTreeWidget(FilteredDirView):
    ...
    def set_workspace(self, root_path):
        ...
        # (see SMlib/widgets/projectexplorer.py).
...
#        p1.set_pythonpath([r"D:\Python\spyder\SMlib"])
#        p1.save()
