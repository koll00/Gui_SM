...
#----Builtins
import __builtin__
from SMlib.widgets.objecteditor import oedit
...
from PyQt4.QtCore import SIGNAL, QObject, QEventLoop

# Local import
from SMlib import get_versions
from SMlib.utils.qthelpers import create_action, get_std_icon
from SMlib.interpreter import Interpreter
from SMlib.utils.dochelpers import getargtxt, getsource, getdoc, getobjdir
from SMlib.utils.misc import get_error_match
#TODO: remove the CONF object and make it work anyway
# In fact, this 'CONF' object has nothing to do in package SMlib.widgets
# which should not contain anything directly related to Spyder's main app
from SMlib.configs.baseconfig import get_conf_path, _, DEBUG
