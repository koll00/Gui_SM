...
from PyQt4.QtGui import QApplication, QMessageBox, QSplitter, QMenu
from PyQt4.QtCore import QProcess, SIGNAL, Qt, QTextCodec
locale_codec = QTextCodec.codecForLocale()

# Local imports
from SMlib.utils.qthelpers import (get_icon, get_std_icon, add_actions,
                                       create_toolbutton, create_action,
                                       DialogManager, getexistingdirectory)
from SMlib.utils.environ import RemoteEnvDialog
from SMlib.utils.programs import get_python_args
from SMlib.utils.misc import get_python_executable
from SMlib.configs.baseconfig import _, get_module_source_path, DEBUG
from SMlib.widgets.shell import PythonShellWidget
from SMlib.widgets.externalshell.namespacebrowser import NamespaceBrowser
from SMlib.widgets.externalshell.monitor import communicate, write_packet
