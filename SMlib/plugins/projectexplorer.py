...
from SMlib.config import VALID_EXT
from SMlib.utils.qthelpers import get_icon, create_action
from SMlib.widgets.projectexplorer import ProjectExplorerWidget
from SMlib.plugins import SMPluginMixin


class ProjectExplorer(ProjectExplorerWidget, SMPluginMixin):
    """Project explorer plugin"""
