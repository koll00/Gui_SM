...
from SMlib.configs.guiconfig import (CUSTOM_COLOR_SCHEME_NAME,
                                 set_default_color_scheme)
from SMlib.utils import programs
from SMlib.utils.qthelpers import get_icon, get_std_icon
from SMlib.configs.userconfig import NoDefault
from SMlib.widgets.colors import ColorLayout
...
#from PyQt4.QtCore import Qt, QSize, SIGNAL, SLOT, Slot
from PyQt4.QtCore import Qt, QSize, SIGNAL, SLOT, pyqtSlot
from SMlib.utils.qthelpers import (to_qvariant, from_qvariant, getexistingdirectory, getopenfilename)
...
class GeneralConfigPage(SMConfigPage):
    CONF_SECTION = None
