...
from SMlib.plugins import SMPluginMixin, PluginConfigPage
from SMlib.widgets.externalshell.monitor import REMOTE_SETTINGS
...
class VariableExplorer(QStackedWidget, SMPluginMixin):
    """
