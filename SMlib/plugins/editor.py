...
from PyQt4.QtGui import (QVBoxLayout, QPrintDialog, QSplitter, QToolBar,
                                ...
                                QKeySequence)
from PyQt4.QtCore import SIGNAL, QByteArray, Qt, Slot
# from PyQt4.compat import to_qvariant, from_qvariant, getopenfilenames
...
# Local imports
from SMlib.utils import encoding, sourcecode, codeanalysis
from SMlib.configs.baseconfig import get_conf_path, _
from SMlib.config import CONF, EDIT_FILTERS, get_filter, EDIT_FILETYPES
from SMlib.configs.guiconfig import get_color_scheme
...
from SMlib.utils.qthelpers import (get_icon, create_action, add_actions,
                                       ...
                                       add_shortcut_to_tooltip,to_qvariant, 
                                       from_qvariant, getopenfilenames)
...
from SMlib.widgets.editor import (EditorSplitter, EditorStack, Printer,
                                      EditorMainWindow)
from SMlib.widgets.sourcecode.codeeditor import CodeEditor
from SMlib.plugins import SMPluginWidget, PluginConfigPage
from SMlib.plugins.runconfig import (RunConfigDialog, RunConfigOneDialog,
...
class Editor(SMPluginWidget):
    ...
    def register_plugin(self):
        ...
        self.connect(self.main.console,SIGNAL("edit_goto(QString,int,QString)"), self.load)
        self.connect(self, SIGNAL('exec_in_extconsole(QString,bool)'),self.main.execute_in_external_console)
        self.connect(self, SIGNAL('redirect_stdio(bool)'),self.main.redirect_internalshell_stdio)
#       self.connect(self, SIGNAL("open_dir(QString)"),self.main.workingdirectory.chdir)
