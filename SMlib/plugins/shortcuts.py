...
from PyQt4.QtGui import (QVBoxLayout, QComboBox, QItemDelegate,
                                QTableView, QMessageBox, QPushButton)
from PyQt4.QtCore import (Qt, QSize, QAbstractTableModel, QModelIndex,
                                 SIGNAL)
#from PyQt4.compat import to_qvariant, from_qvariant

import sys

# Local imports
from SMlib.configs.baseconfig import _
from SMlib.configs.guiconfig import (get_shortcut, set_shortcut,
                                 iter_shortcuts, reset_shortcuts)
from SMlib.utils.qthelpers import get_icon,to_qvariant, from_qvariant
from SMlib.plugins.configdialog import GeneralConfigPage
